...
const TIPOS = ["Mensal","Bimestral","Trimestral","Extra","Quadrimestral","Semestral","Ensaio Regional":"Ensaio Regional","Teste e Exames":"Teste e Exames"];
const TIPO_COLOR = {
  "Mensal":        "#2f6fed",
  "Bimestral":     "#1a9c67",
  "Trimestral":    "#e07b1f",
  ...
  "Semestral":     "#6b7280",
  "Ensaio Regional": "#6b7580",
  "Teste e Exames": "#6b7980"
...
function buildFilterOptions() {
  FILTER_DEFS.forEach(d => {
    ...
    let values;
    if (d.key === "tipo") values = orderedIntersect(TIPOS, disponiveis.map(FILTER_MATCHERS.tipo));
...
const TIPO_NORMALIZE = {
  ...
  "quatrimestrais":"Quadrimestral", "semestral":"Semestral", "sementral":"Semestral","Ensaio Regional":"Ensaio Regional","Teste e Exames":"Teste e Exames"
};
