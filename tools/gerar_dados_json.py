...
TIPO_MAP = {"Mensal":"Mensal","Bimestral":"Bimestral","Extras":"Extra",
            "Quatrimestrais":"Quadrimestral","Sementral":"Semestral","Trimestrais":"Trimestral","Ensaio Regional":"Ensaio Regional","Teste e Exames":"Teste e Exames"}
...
def main(path):
    ...
    out = {"meta": {"totalRegistros": len(records), "fonte": path,
                     "tiposEnsaio": ["Mensal","Bimestral","Trimestral","Extra","Quadrimestral","Semestral","Ensaio Regional","Teste e Exames"]},
           "ensaios": records}
